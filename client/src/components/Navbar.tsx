...
const Navbar = () => {
  // Données simulées pour le wallet et le nom de l'utilisateur
  const walletAmount = "1,250.50 €";
  ...
  return (
    <nav className="h-16 glass-effect flex items-center justify-between px-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <button className="h-10 px-4 bg-white text-dark-900 rounded-lg hover:opacity-90 flex items-center space-x-2 transition-opacity duration-300">
        ...
        <button
          type="button"
          className="h-10 px-4 bg-white text-gray-900 rounded-lg hover:opacity-90 flex items-center space-x-2 transition-opacity duration-300 dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700"
        >
          <svg
            aria-hidden="true"
